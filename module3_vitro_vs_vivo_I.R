...
### Code below simply reorders rows and columns. May not be required ###
# meta_jaccard_vivovitro <- meta_jaccard_vivovitro[rev(c('melanoma.MITF.program', 
#                                                        'HNSCC.Epidif.1', 
#                                                        'episen', 
#                                                        'melanoma.AXL.program', 
#                                                        'HNSCC.PEMT', 
#                                                        'emt', 
#                                                        'GBM.MES1', 
#                                                        'ovarian.ifn', 
